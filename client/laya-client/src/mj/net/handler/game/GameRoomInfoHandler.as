package mj.net.handler.game
{
     ...
     */
    public final class GameRoomInfoHandler implements MessageHandler
    {
        public static const instance:GameRoomInfoHandler = new GameRoomInfoHandler();

        public function GameRoomInfoHandler()
        {
            if (instance != null)
            {
        ...
        {
            return inHandler(GameRoomInfo(msg));
        }

        /**
         * @return 返回true 表示需要脱离缓冲，不然这个消息的内容可能被覆盖
         */
        private function inHandler(msg:GameRoomInfo):Boolean
        {
