 ...
 */
public class SettingForm implements ApiMessage {
	...
	public SettingForm(String notice, String radio, String payInfo, String agreement, int initGold) {
		this.notice = notice;
		this.radio = radio;
	...
	public String toString() {
		return "SettingForm [notice=" + notice + ",radio=" + radio + ",payInfo=" + payInfo + ",agreement=" + agreement
				+ ",initGold=" + initGold + ", ]";
	}
}